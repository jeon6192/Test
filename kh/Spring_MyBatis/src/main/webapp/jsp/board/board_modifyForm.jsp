...
<body>
	...
	<form action="./board_update_ok.nhn" method="post" name="boardform">
		<ul class="write_ul">
			<li class="name_li">
				<div>글쓴이</div>
				<div>
					<input class="input_box" name="board_name" id="name" type="text" size="15" maxlength="30"
						value="${boardBean.board_name}" readonly="readonly">
				</div>
			</li>
			<li class="pass_li">
				<div>비밀번호</div>
				<div>
					<input class="input_box" name="board_pass" id="pass" type="password" size="15" maxlength="30">
				</div>
			</li>
			<li class="subject_li">
				<div>제목</div>
				<div>
					<input class="input_box" name="board_subject" id="subject" type="text" size="50" maxlength="100"
			...
			<li class="content_li">
				...
				<div style="float: right;">
					<textarea rows="15" cols="60" name="board_content" id="content">${boardBean.board_content}</textarea>
				</div>
			</li>
