...
<html>
	...
	<body>
		<form action="./bbs_write_ok.nhn" method="post" name="bbsform" onsubmit="return check()" enctype="multipart/form-data">
			<ul class="write_ul">
				<li class="name_li">
					<div>글쓴이</div>
				...
				<li class="subject_li">
					<div>제목</div>
					<div><input class="input_box" name="bbs_subject" id="subject" type="text" size="50" maxlength="100"></div>
				</li>
				<li class="content_li">
					<div>내용</div>
