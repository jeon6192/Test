package com.naver.member.action;
...
import com.naver.member.dao.MemberService;
import com.naver.member.model.MemberBean;
import com.naver.member.model.ZipcodeBean;
import com.naver.member.model.ZipcodeBean2;
...
public class MemberAction {
	...
	@RequestMapping(value = "/zipcode_find_ok.nhn")
	@ResponseBody
	public Object zipcode_find_ok(@RequestParam String dong, 
			HttpServletResponse response) throws Exception{
		...
		System.out.println("size : "+zipcodeList2.size());
		//response.getWriter().println(zipcodeList2);
		return zipcodeList2;
