...
<html>
	...
	<body>
		<form action="./board_reply_ok.nhn" method="post" name="boardform">
			...
			<ul class="write_ul">
				...
				<li class="subject_li">
					<div>제목</div>
					<div>
						<input class="input_box" name="board_subject" id="subject" type="text" size="50" maxlength="100" value="답변 : ${boardBean.board_subject}">
					</div>
				</li>
				<li class="content_li">
					<div>내용</div>
